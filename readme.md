# Pepper target detection dataset 900 images supports yolo suitable for plant recognition

# Body

Pepper target detection dataset, 900 images, supports yolo, suitable for plant recognition, object detection, agricultural AI research, clear images, complete annotations, ready to use, time-saving and labor-saving.
